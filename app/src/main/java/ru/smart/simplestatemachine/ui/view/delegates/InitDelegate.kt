...
class InitDelegate: IDelegate<ViewState, AppCompatActivity> {

    private lateinit var stateName: TextView
    private lateinit var btnNext: Button

    override fun onBind(viewState: ViewState) {
        viewState as ViewState.InitViewState
    ...
    override fun isFor(entry: ViewState) = entry is ViewState.InitViewState
